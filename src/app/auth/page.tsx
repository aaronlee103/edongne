  ...
  return (
    <div className="max-w-md mx-auto px-4 py-16">
      ...
      <div className="space-y-3">
        ...
        {/* Facebook 로그인 - Meta 앱 승인 후 hidden 제거 */}
        <button
          onClick={handleFacebookLogin}
          disabled={loading !== null}
          className="hidden w-full flex items-center justify-center gap-3 py-3 bg-[#1877F2] rounded-lg hover:bg-[#166FE5] transition-colors text-sm font-medium text-white disabled:opacity-50"
        >
